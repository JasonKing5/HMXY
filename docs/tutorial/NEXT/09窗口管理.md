...
class MySubWindow{
  ...
  async showSubWindow(subWindowOption:SubWindowOption) {
    ...
    if (this.windowStage_ == null) {
      ...
      // this.sub_windowClass.resize(800, 800)
      this.sub_windowClass.moveWindowTo(subWindowOption.x, subWindowOption.y)
      this.sub_windowClass.resize(subWindowOption.width, subWindowOption.height)
      // 窗口里面得有内容
      // this.sub_windowClass.setUIContent("pages/SubWindowContent", () => {
