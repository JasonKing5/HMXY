...
![image-启动UIAbility](screenshots/readme/启动UIAbility.png)
...
|                        拉起方录入数据                        |                    被拉起方获取数据并使用                    |
| :----------------------------------------------------------: | :----------------------------------------------------------: |
| ![image-20250624200609629](screenshots/readme/启动并携带数据.png) | ![image-20250624200701773](screenshots/readme/接受数据并使用.png) |
...
![应用间跳转](screenshots/readme/应用间跳转.gif)
